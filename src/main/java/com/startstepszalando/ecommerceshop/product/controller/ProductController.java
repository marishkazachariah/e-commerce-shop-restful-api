...
public class ProductController {
    ...
    @Operation(summary = "Add a new product",
            description = "This allows users with the ADMIN role to create a new product. The product name should be unique for every user.",
    ...
    @Operation(summary = "Update an existing product",
            description = "This allows users with the ADMIN role to update an existing product. The product name should be unique for every user.",
            security = {@SecurityRequirement(name = "bearerAuth")},
            responses = {
    ...
    @Operation(summary = "Delete an existing product by ID",
            description = "This allows users with ADMIN role to delete an existing product that the ADMIN created.",
            security = {@SecurityRequirement(name = "bearerAuth")},
            responses = {
    ...
    @Operation(summary = "Retrieve all products",
            description = "Returns all products in a paginated view.",
            responses = {
